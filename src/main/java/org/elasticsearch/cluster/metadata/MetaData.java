...
public class MetaData implements Iterable<IndexMetaData> {
     ...
     */
    public Map<String, Set<String>> resolveSearchRouting(Set<String> routing, String[] aliasesOrIndices) {
     ...
     */
    private Map<String, Set<String>> resolveSearchRoutingAllIndices(Set<String> routing) {
