...
public interface SearchService {
    ...
    QuerySearchResult executeQueryPhase(ShardSearchRequest request) throws ElasticsearchException;
    ...
    FetchSearchResult executeFetchPhase(FetchSearchRequest request) throws ElasticsearchException;
