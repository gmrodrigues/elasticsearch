...
public class InternalSearchService extends AbstractLifecycleComponent<SearchService> implements SearchService {
    ...
    @Inject
    public InternalSearchService(Settings settings, ClusterService clusterService, IndicesService indicesService, IndicesWarmer indicesWarmer, ThreadPool threadPool,
        ...
        indicesService.indicesLifecycle().addListener(new IndicesLifecycle.Listener() {
            ...
            public void afterIndexClosed(Index index, @IndexSettings Settings indexSettings) {
                ...
                IndexMetaData idxMeta = InternalSearchService.this.clusterService.state().metaData().index(index.getName());
